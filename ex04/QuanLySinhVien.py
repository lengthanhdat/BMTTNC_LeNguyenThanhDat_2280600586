...
class QuanLySinhVien:
    ...
    def sortByID(self):
        self.listSinhVien.sort(key=lamba x: x._id, reverse=False)
    
    def sortByName(self):
        self.listSinhVien.sort(key=lamba x: x._name, reverse=False)
    
    def sortByDiemTB(self):
        self.listSinhVien.sort(key=lamba x: x._diemTB, reverse=False)
